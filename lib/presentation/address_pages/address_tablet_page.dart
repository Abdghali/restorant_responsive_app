...
class AddressTabletPage extends StatefulWidget {
  AddressPageController addressPageController;
  AddressTabletPage({Key? key, required this.addressPageController})
      : super(key: key);

  @override
  State<AddressTabletPage> createState() => _AddressTabletPageState();
}

class _AddressTabletPageState extends State<AddressTabletPage> {
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        MaterialTextFormFeild(
                            hintText: 'Name',
                            suffixText: 'Name',
                            validator: (value) => nullValidator(value, 'Name'),
                        ...
                        MaterialTextFormFeild(
                            ...
                            textInputType: TextInputType.text,
                            onChanged: (country) {
                              widget.addressPageController.setCountry(country);
                            }),
                        SizedBox(
                          height: 5.h,
                        ),
