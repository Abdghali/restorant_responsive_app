...
import 'package:restaurant_app/presentation/address_pages/address_page.dart';
...
class CartMobilePage extends GetView<CartPageController> {
  CartPageController cartPageController;
  CartMobilePage({Key? key, required this.cartPageController})
      : super(key: key);
